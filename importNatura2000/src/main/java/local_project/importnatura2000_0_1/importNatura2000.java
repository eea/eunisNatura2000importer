	...
	public void tMysqlInput_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tMysqlInput_2 = "select ID_SITE from chm62edt_sites where SOURCE_DB='NATURA2000' and ID_SITE not in (select site_code from eunis2014.importSitesTmp)";
...
/************************************************************************************************
 * 131752 characters generated by Talend Open Studio for Big Data on the
 * September 29, 2016 6:38:01 PM CEST
 ************************************************************************************************/
