		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "/var/local/build/eea.eunis/local.properties";
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								"/var/local/build/eea.eunis/local.properties",
								"ISO-8859-15", "=", "\n", true, 0, 0, -1, -1,
								false);
							...
							if (row8 != null) {
								...
								row8.value = StringUtils.replaceAllStrictly(
										row8.value, searchStr_tReplace_2_3, ""
												+ "", false, false);
								String searchStr_tReplace_2_4 = "mysql.user"
										+ "";
								row8.key = StringUtils.replaceAllStrictly(
										row8.key, searchStr_tReplace_2_4,
										"dbUsername" + "", false, false);
								String searchStr_tReplace_2_5 = "mysql.password"
										+ "";
								row8.key = StringUtils.replaceAllStrictly(
										row8.key, searchStr_tReplace_2_5,
										"dbPassword" + "", false, false);
								String searchStr_tReplace_2_6 = "mysql.url"
										+ "";
								row8.key = StringUtils.replaceAllStrictly(
								...
								if (row9.key != null) {
									tmp_key_tContextLoad_2 = row9.key.trim();
									if ((tmp_key_tContextLoad_2.startsWith("#") || tmp_key_tContextLoad_2
											.startsWith("!"))) {
										tmp_key_tContextLoad_2 = null;
									} else {
										row9.key = tmp_key_tContextLoad_2;
									}
								}
								if (row9.key != null) {
									key_tContextLoad_2 = row9.key;
								}
								String value_tContextLoad_2 = null;
								if (row9.value != null) {
									value_tContextLoad_2 = row9.value;
								}
					...
					if (!((Object) ("/var/local/build/eea.eunis/local.properties") instanceof java.io.InputStream)) {
	...
	public void tSystem_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				command_tSystem_1[2] = "/usr/local/bin/natura2000importer-1.0-SNAPSHOT-jar-with-dependencies.jar";
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				try {
					...
					while (rs_tMysqlInput_2.next()) {
						...
						command_tSystem_2[2] = "/usr/local/bin/eunisctl-1.0-SNAPSHOT-jar-with-dependencies.jar";
...
/************************************************************************************************
 * 114315 characters generated by Talend Open Studio for Data Integration on the
 * March 1, 2016 9:33:45 AM CET
 ************************************************************************************************/
